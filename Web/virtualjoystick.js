var VirtualJoystick	= function(opts)
{
	...
	this._strokeStyle	= opts.strokeStyle	|| 'maroon';
...
{
	this._pressed	= false;
	this._show ?  this._stickEl.style.display	= "" : this._stickEl.style.display	= "";
...
VirtualJoystick.prototype._move = function(style, x, y) // moves the top left of canvas to (x,y).
{
	if (this._transform) {
		if (this._has3d) {
